...
if word_input[0]== single_char:
    print("found "+single_char+ " at index 0")
    count_instance+=1
if word_input[1]== single_char:
    print("found "+single_char+ " at index 1")
    count_instance+=1
if word_input[2]== single_char:
    print("found "+single_char+ " at index 2")
    count_instance+=1
if word_input[3]== single_char:
    print("found "+single_char+ " at index 3")
    count_instance+=1
if word_input[4]== single_char:
    print("found "+single_char+ " at index 4")
    count_instance+=1
if count_instance==0:
